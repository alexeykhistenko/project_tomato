...
#(<tf.Tensor 'input/shuffle_batch:0' shape=(100, 10000) dtype=float32>, <tf.Tensor 'input/shuffle_batch:1' shape=(100,) dtype=int32>)
#(<tf.Tensor 'IteratorGetNext:0' shape=(?, 10000) dtype=float32>, <tf.Tensor 'IteratorGetNext:1' shape=(?,) dtype=int32>)
